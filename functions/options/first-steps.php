...
class SunflowerFirstStepsPage
{
    ...
    public function sunflower_first_steps_page_init(): void
    {
        ...
        add_settings_section(
            'sunflower-first-steps', // ID
            __('Activate Theme', 'sunflower'), // Title
            $this->print_section_info(...), // Callback
            'sunflower_admin' // Page
        );

        add_settings_field(
            'sunflower_terms_of_use', // ID
            __('Sunflower Terms of Use', 'sunflower'), // Title
            $this->sunflower_checkbox_terms_conditions_callback(...), // Callback
            'sunflower_admin', // Page
...
if (is_admin()) {
    $my_settings_page = new SunflowerFirstStepsPage();
}
