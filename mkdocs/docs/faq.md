...
Für das Bildmanagement im neuen Theme Sunflower26 bitte auch [diese Hinweise beachten](umstieg_sunflower26.md).
...
Das Sunflower-Theme bietet die Möglichkeit in den Einstellungen sicherzustellen, dass es bei fehlenden Bildrechten keine Probleme gibt. [mehr](setup.md#anzeige-von-bildern-medien-urheberin)
