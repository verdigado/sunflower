...
! ( function ( e, t ) {
	...
	! ( function () {
		...
		function _( t ) {
			return function ( e ) {
				return (
					( fe( e, 'input' ) || fe( e, 'button' ) ) && e.type === t
				);
			};
		}
		function z( t ) {
					...
					contains: F( function ( t ) {
						return (
							...
							function ( e ) {
								return (
									-1 <
									( e.textContent || ce.text( e ) ).indexOf(
										t
									)
								);
							}
	...
	( ce.event = {
		...
		dispatch: function ( e ) {
			var t,
				...
				u = ce.event.fix( e ),
				l =
					( _.get( this, 'events' ) || Object.create( null ) )[
						u.type
					] || [],
	...
	function $e( n, r, i, o ) {
		...
		if (
			f &&
			( ( t = ( e = Ae( r, n[ 0 ].ownerDocument, ! 1, n, o ) )
				.firstChild ),
			1 === e.childNodes.length && ( e = t ),
			t || o )
		) {
			for (
				s = ( a = ce.map( Se( e, 'script' ), Ie ) ).length;
				c < f;
				c++
			)
				( u = e ),
