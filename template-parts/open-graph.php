...
<meta property="og:description" content="<?php echo esc_attr(strip_tags((string) get_the_excerpt())); ?>">
...
<meta name="twitter:description" content="<?php echo esc_attr(strip_tags((string) get_the_excerpt())); ?>">
